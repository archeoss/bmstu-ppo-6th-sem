...
*Тип приложения* - Cross-Platform

*Технологический стек* - Rust (Backend: Actix), TypeScript (Frontend: React), Tailwind, Tauri (For Cross-Platforming), SurrealDB
### Обоснование.

1. Rust — быстрый и надежный язык программирования с низкоуровневым управлением, что делает его идеальным для создания высокопроизводительных серверных систем. 
Actix, веб-фреймворк на основе Rust, также очень эффективен, что делает его отличным выбором для веб-разработки.

2. TypeScript — популярный язык разработки внешнего интерфейса, обеспечивающий проверку типов и улучшенную структуру кода.
Это обеспечивает более надежную и поддерживаемую кодовую базу. 
React, широко используемая библиотека внешнего интерфейса, которая известна своей эффективной отрисовкой и плавным управлением состояний, 
что обеспечивает быстрое и плавное взаимодействие с пользователем.

3. Tailwind — это прежде всего легковесный CSS фреймворк, который предоставляет набор предопределенных классов CSS для стилизации веб-приложений.
Это помогает разработчикам создавать современные и адаптивные дизайны с минимальными усилиями и снижает потребность в пользовательском коде CSS.

4. Tauri — это фреймворк для создания кроссплатформенных настольных приложений, похожий на Electron, но позволяющий использовать Rust вместо Node.js. Его основное преимущество перед Electron заключается в более эффективном использовании ресурсов: Меньший расход памяти, меньшая нагрузка на процессор, меньший размер исполняемого файла. 
Он поддерживает широкий спектр платформ, включая Windows, macOS и Linux, и предоставляет доступ к собственным API-интерфейсам, что обеспечивает беспрепятственную интеграцию с хост-системой.

5. SurrealDB — NewSQL база данных, которая обеспечивает быстрое и надежное хранилище данных для веб-приложений. 
Он создан на Rust и предназначен для обработки высокопроизводительных рабочих нагрузок с малой задержкой, 
что делает его идеальным выбором для современных веб-приложений.

### Верхнеуровневое разбиение на компоненты. 

![High-Level Breakup](./img/high-level-breakup.png)

### UML диаграммы классов для двух отдельных компонентов - компонента доступа к данным и компонента с бизнес-логикой

![UML](./img/Components.png)
